	...
	<?php
		...
		<?php } ?>
			...
			<div class="comment-details">
				...
				<!-- <h1 class="fn"><?php// echo comment_author($comment->$comment_ID);?></h1> -->
					<div ><?php
						printf( __( '<h4 class="fn">%s</h4> <span class="says">says:</span>', 'textdomain' ), get_comment_author() ); 
						/* translators: 1: date, 2: time */
						echo " -  ";
						printf( __( '', 'textdomain' ), commentCount() );
						echo " -  ";
						printf(
							__( '%1$s', 'textdomain' ),
							get_comment_date(),
